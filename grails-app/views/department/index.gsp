...
<fieldset>
<legend><h1 style="margin-left: 20%; margin-top: 10%;"> These are the Employees of the ${params.deptid} department</h1></legend>
...
<g:link controller="Employee" action="addIndex" style="margin-left: 40%;"> <Button type = "button"class="btn-block btn-primary" > Add an Employee!</Button></g:link>
 </fieldset>
</body>
</html>
